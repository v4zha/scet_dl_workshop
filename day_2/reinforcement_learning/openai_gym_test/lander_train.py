...
model = TD3(state_dim=state_dim, action_dim=action_dim, max_action_val=max_action_val,
            checkpt_file_path="checkpoints/lander_td3", load_checkpoint=resume_training, actor_lr=1e-3, critic_lr=1e-3, log_dir="logs/lander_td3_train")
...
for episodes in tqdm(range(max_episodes+1)):
    ...
    while not done and not truncated:
        ...
        if len(model.replay_buffer) > batch_size:
            ...
            if train_res is not None:
                ...
                # print("Step : ", step_count, " Actor Loss : ",
    ...
    if avg_reward > best_reward:
        ...
        model.save_checkpoint("checkpoints/lander_td3")
